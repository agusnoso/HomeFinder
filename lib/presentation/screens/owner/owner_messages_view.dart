...
class OwnerMessagesView extends StatefulWidget {
  ...
  @override
  State<OwnerMessagesView> createState() => _OwnerMessagesViewState();
}

class _OwnerMessagesViewState extends State<OwnerMessagesView> {
  ...
  void initState() {
    super.initState();
    _messagesFuture = _propertyService.getOwnerRequests();
  }
