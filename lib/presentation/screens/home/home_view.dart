          ...
          children: [
            ...
            if (esPropietario) ...[
              _HomeOptionCard(
                ...
                onTap: () => Navigator.pushNamed(context, '/owner/publish-property'),
              ),
              _HomeOptionCard(
                icon: Icons.home_work,
                title: 'Mis viviendas',
                subtitle: 'Consulta y gestiona tus inmuebles publicados',
                onTap: () => Navigator.pushNamed(context, '/owner/my-properties'),
              ),
              _HomeOptionCard(
            ...
            if (esHuesped) ...[
              _HomeOptionCard(
                ...
                onTap: () => Navigator.pushNamed(context, '/guest/search-properties'),
              ),
              _HomeOptionCard(
                icon: Icons.apartment,
                title: 'Viviendas disponibles',
                subtitle: 'Consulta inmuebles en alquiler o venta',
                onTap: () => Navigator.pushNamed(context, '/guest/available-properties'),
              ),
              _HomeOptionCard(
                icon: Icons.list_alt,
                title: 'Mis solicitudes',
                subtitle: 'Revisa las solicitudes que has enviado',
                onTap: () => Navigator.pushNamed(context, '/guest/requests'),
              ),
              _HomeOptionCard(
                icon: Icons.message,
                title: 'Mensajes',
                subtitle: 'Comunícate con propietarios',
                onTap: () => Navigator.pushNamed(context, '/guest/messages'),
              ),
            ],
          ],
        ),
